...
/// Test code
    // let admin1_layer = L.geoJSON(admin1_data.features, {
    //     style: function (feature) {
    //     return {
    //         color: "white",
    //         fillColor: chooseColor(feature.properties.admin1),
    //         fillOpacity: 0.5,
    //         weight: 1.5
    //     }
    //     },
    ...
    //     layer.bindPopup("<h1>" + feature.properties.admin2 + "</h1> <hr> <h2>" + feature.properties.admin1 + "</h2>");
